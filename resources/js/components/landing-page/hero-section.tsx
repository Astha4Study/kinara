            ...
            <section className="relative flex min-h-screen items-center justify-center overflow-hidden rounded-2xl md:min-h-[calc(100vh-96px)]">
                ...
                <div className="relative z-10 flex h-full items-center justify-center px-6 md:mb-20">
                    <div className="w-full max-w-5xl text-center text-white">
                        ...
                        {/* CTA */}
                        <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row md:hidden">
                            <button className="inline-flex items-center justify-center rounded-full bg-emerald-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-emerald-700">
                                Cari Klinik Sekarang
                            </button>
                        </div>
                    </div>
                </div>
                ...
                {/* Bottom Section */}
                <div className="absolute inset-x-6 bottom-4 z-20 hidden md:block">
