...
interface FormEditPasienOnlineResepsionisProps {
    data: any;
...
const FormEditPasienOnlineResepsionis: React.FC<FormEditPasienOnlineResepsionisProps> = ({
    data,
    setData,
    handleSubmit,
    processing,
...
export default FormEditPasienOnlineResepsionis;
