...
const DataPasienResepLengkap = ({ pasien, diagnosa, punya_server }: Props) => {
    const hasRiwayat =
    ...
    return (
        <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
            <div className="space-y-6 p-6">
                ...
                {/* Diagnosa Dokter */}
                <div className="mt-2">
                    {punya_server === 1 && hasDiagnosa ? (
                        <Highlight label="Diagnosa Dokter" value={diagnosa} />
                    ) : (
...
export default DataPasienResepLengkap;
