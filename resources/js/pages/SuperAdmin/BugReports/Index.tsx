...
export default function BugReportsIndexSuperAdmin() {
                        ...
                        <table className="w-full min-w-max text-sm">
                            <thead>
                                <tr className="border-b border-gray-200 bg-gray-50">
                                    ...
                                    <th className="px-6 py-3 text-center text-xs font-medium tracking-wider whitespace-nowrap text-gray-500 uppercase">
                                        Aksi
                                    </th>
                                </tr>
                            </thead>
                                ...
                                {filteredBugs.length > 0 ? (
                                    filteredBugs.map((bug) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4">
                                                <span
                                                    className={`rounded-full px-3 py-1 text-xs font-medium ${priorityColor[bug.prioritas]}`}
                                                >
                                                    {bug.prioritas}
                                                </span>
                                            </td>
